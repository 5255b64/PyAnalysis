...
# CLUSTER_NUM_SAMPLE_LIST = list(range(1, 1001))  # 聚类的簇数量的采样
CLUSTER_NUM_SAMPLE_LIST_1000 = list(range(1, 1001, 1))  # 聚类的簇数量的采样
CLUSTER_NUM_SAMPLE_LIST_3000 = list(range(1, 1001, 1))  # 聚类的簇数量的采样
